...
- [WORK.md](WORK.md) — журнал текущих задач, архитектурных решений, коммитов и восстановления прогресса. Перед продолжением незавершённой задачи прочитайте его и обновляйте по мере работы.
