...
- [ ] Read exact damage, ability, effect, ECS and playground contracts; finish integration design.
- [ ] Implement typed data definitions, catalog adapter, prototype rules and resistance/gauge state.
...
The original branch is untouched. The working branch was created from the exact requested head. No Godot runtime tests have been run. Continue with the next unchecked task; do not discard or squash completed work.
