...
static func attack() -> AbilityDefinition:
	...
	definition.display_name = "Attack"
...
static func shoot() -> AbilityDefinition:
	var definition := AbilityDefinition.new()
	definition.id = &"shoot"
	definition.display_name = "Shoot"
	definition.delivery = AbilityDefinition.Delivery.PROJECTILE
	definition.timing = AbilityDefinition.Timing.ATTACK
	definition.base_cast_work = 0.20
	definition.base_cooldown = 0.55
	definition.flat_damage = 5.0
	definition.damage_scale = 1.0
	definition.range = 30.0
	definition.projectile_speed = 28.0
	definition.projectile_lifetime = 3.0
...
static func fireball() -> AbilityDefinition:
	...
	definition.display_name = "Fireball"
	definition.delivery = AbilityDefinition.Delivery.PROJECTILE
	...
	definition.flat_damage = 25.0
	definition.damage_scale = 1.25
